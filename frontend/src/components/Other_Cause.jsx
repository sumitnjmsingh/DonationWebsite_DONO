...
const [USER,setUser]=useState({
   ...
   const res=await fetch("http://localhost:3000/api/users/otherCause",{
     method:"POST",
     credentials: 'include',
  ...
  return (
    <div>
        ...
        <div className='w-screen h-screen flex flex-col justify-center items-center text-[12px] gap-2'>
          ...
          <form method='POST' className='flex  flex-col lg:w-[28%] w-[45%] h-[65%] bg-white  rounded-[5px] p-1 lg:p-3 gap-1 lg:gap-2 bg-[url("back4.png")] bg-no-repeat bg-cover shadow-2xl'>
            ...
            <div className='flex justify-center items-center gap-1 lg:gap-2'><div className='text-blue-500 text-[15px]'><FaGlobe /></div><p>Raising funds for <span className='font-bold'>Other </span> purpose</p></div>
            <div className='flex flex-col items-start'>
                ...
                <div className='flex items-start justify-center p-1 w-[90%]'>
                     <input name="orgname" value={USER.orgname} onChange={handleinput} placeholder='Whom are you raising funds for?' className=' w-[90%] border-b-solid border-b-black border-b-[1px] outline-none p-1'></input>
                </div>
                <div className='flex items-start justify-center p-1 w-[90%] '>
