  ...
  return (
    <div>
        ...
        <div className='w-screen h-screen flex flex-col justify-center items-center text-[12px] gap-2'>
          ...
          <div className='flex  flex-col lg:w-[28%] w-[45%] h-[65%] bg-white  rounded-[5px] p-1 lg:p-3 gap-1 lg:gap-2 bg-[url("back4.png")] bg-no-repeat bg-cover shadow-2xl'>
            ...
            <div className='flex flex-col items-start'>
                ...
                <div className='flex items-start justify-center p-1 w-[90%]'>
                     <input placeholder='Whom are you raising funds for?' className=' w-[90%] border-b-solid border-b-black border-b-[1px] outline-none p-1'></input>
                </div>
                <div className='flex items-start justify-center p-1 w-[90%] '>
